(() => {
  ...
  const levels = {
    ...
    3: {
      ...
      boxes: [
        { x: 2, y: 5, label: '', slash: true, owner: 'fusion', target: { x: 2, y: 2 } },
        { x: 5, y: 1, label: '', slash: true, owner: 'fusion', target: { x: 2, y: 1 } },
        { x: 7, y: 5, label: '', slash: false, owner: 'fusion', target: { x: 7, y: 1 } },
        { x: 4, y: 2, label: '', slash: false, owner: 'fusion', target: { x: 7, y: 2 } }
      ],
      emitter: { x: -1, y: 2, direction: { x: 1, y: 0 } },
      receiver: { x: 10, y: 2 },
      targets: [
        { x: 1, y: 2, label: 'ALIGN' },
        { x: 4, y: 1, label: 'ROUTE' },
        { x: 6, y: 1, label: 'CHARGE' },
        { x: 9, y: 2, label: 'HOME' }
      ]
    }
  };
  ...
  function addTerrain(tile) {
    ...
    element.innerHTML = '<span></span><i></i><i></i><i></i><i></i>';
  ...
  function addWall(wall) {
    ...
    element.innerHTML = '<span aria-hidden="true"></span><i></i><i></i><i></i><i></i><small></small>';
