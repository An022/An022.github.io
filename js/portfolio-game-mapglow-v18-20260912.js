(() => {
  ...
  const levels = {
    1: {
      ...
      boxes: [
        { x: 4, y: 5, label: 'ASK WHY', order: 0, target: { x: 2, y: 5 } },
        { x: 8, y: 5, label: 'READ DATA', order: 1, target: { x: 9, y: 5 } },
        { x: 4, y: 3, label: 'SPOT RISK', order: 2, target: { x: 7, y: 3 } },
        { x: 7, y: 1, label: 'MAKE CALL', order: 3, target: { x: 2, y: 1 } }
      ]
    },
    2: {
      mode: 'lasermaze',
