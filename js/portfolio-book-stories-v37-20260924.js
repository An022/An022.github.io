(() => {
  ...
  pages.forEach((page, index) => {
    ...
    dot.innerHTML = `<span>${String(index + 1).padStart(2, '0')}</span><strong>${page.dataset.bookPage}</strong>`;
  ...
  function showPage(index, updateHash = false) {
    ...
    document.getElementById('main').dataset.currentPage = String(currentPage + 1);
