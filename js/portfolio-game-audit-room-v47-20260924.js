(() => {
  ...
  const levels = {
    1: {
      ...
      copy: 'Business judgment follows a sequence. Restore the room as you would handle a business decision.',
      player: 'business',
      start: { x: 4, y: 6 },
      techStart: { x: 10, y: 4 },
      storyPortal: { x: 0, y: 6 },
  ...
  function restoreSokoban(snapshot) {
    ...
    gameStatus.textContent = 'Move rewound. Reorganize the warehouse and try another route.';
  }
