window.AN_STORY_FULL = {
  id: 'an-illustrated-story-polished-type',
  title: "An's Story",
  scenes: [
    {
    ...
    },
    {
      ...
      elements: [
        ...
        { id: 'projects', type: 'emphasis', content: 'Across complex engagements,', visibleFrom: 2, className: 'copy-title copy-title--small' },
    ...
    },
    {
      ...
      elements: [
        ...
        { id: 'boc-copy', type: 'text', content: 'Nightly loan processing rebuilt into a reliable, traceable data workflow.', visibleFrom: 2, className: 'copy-line copy-line--project-secondary' },
